          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 mb-4">
                "Abby has been incredibly helpful during my difficult times. Having someone to talk to 24/7 has made
                such a difference."
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 mb-4">
                "Abby provides practical advice and emotional support whenever I need it. It's like having a therapist
                in my pocket."
              </p>
          ...
          <div className="space-y-8">
            <div className="border-b border-gray-200 pb-8">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                Is Abby a replacement for professional therapy?
              </h3>
              <p className="text-gray-600">
                Abby is designed to provide support and guidance, but it's not a replacement for professional mental
                health care. If you're experiencing severe mental health issues, we recommend consulting with a licensed
                therapist or counselor.
              </p>
            </div>
            <div className="border-b border-gray-200 pb-8">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Is my conversation with Abby private?</h3>
              <p className="text-gray-600">
            ...
            <div className="border-b border-gray-200 pb-8">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">How much does Abby cost?</h3>
              <p className="text-gray-600">
                Abby offers both free and premium plans. The free plan includes basic chat functionality, while premium
                plans offer additional features and unlimited conversations.
              </p>
            </div>
            <div className="border-b border-gray-200 pb-8">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                What types of issues can I discuss with Abby?
              </h3>
              <p className="text-gray-600">
                You can discuss a wide range of everyday problems including stress, relationships, work issues, anxiety,
                and general life challenges. Abby is here to listen and provide supportive guidance.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-2xl font-bold mb-4">Abby</h3>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Abby. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
