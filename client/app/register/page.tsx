      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-80px)] px-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Create your account to begin your therapy journey</p>
          </div>
          ...
          <form className="space-y-6">
            ...
            <Button variant="outline" className="w-full py-3 border-gray-300 hover:bg-gray-50 bg-transparent">
